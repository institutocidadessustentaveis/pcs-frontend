...
@Component({
  selector: 'app-comparar-indicadores-diferentes-mesmacidade-grupo-cidade',
  templateUrl: './comparacao-mesma-cidade-grupo-cidade.component.html',
  styleUrls: ['./comparacao-mesma-cidade-grupo-cidade.component.css']
})

export class CompararIndicadoresDiferentesMesmaCidadeGrupoCidadeComponent implements OnInit {
