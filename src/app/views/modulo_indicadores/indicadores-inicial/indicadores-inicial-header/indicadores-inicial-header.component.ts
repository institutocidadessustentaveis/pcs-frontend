...
@Component({
  selector: 'app-indicadores-inicial-header',
  templateUrl: './indicadores-inicial-header.component.html',
  styleUrls: ['./indicadores-inicial-header.component.css', './home.component.scss']
})
export class IndicadoresInicialHeaderComponent implements OnInit {
