...
@Component({
  selector: 'app-boas-praticas-inicial-secoes',
  templateUrl: './boas-praticas-inicial-secoes.component.html',
  styleUrls: ['./boas-praticas-inicial-secoes.component.css', './home.component.scss']
})
export class BoasPraticasInicialSecoesComponent implements OnInit {
