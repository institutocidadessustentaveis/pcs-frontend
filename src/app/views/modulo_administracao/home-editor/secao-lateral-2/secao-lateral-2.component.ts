...
@Component({
  selector: 'app-secao-lateral-2',
  templateUrl: './secao-lateral-2.component.html',
  styleUrls: ['./secao-lateral-2.component.css',
  './secao-lateral-2-home.component.css',
  './secao-lateral-2.component.scss']
})

export class SecaoLateral2Component implements OnInit {
