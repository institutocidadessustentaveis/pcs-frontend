...
@Component({
  selector: 'app-secao-lateral-4',
  templateUrl: './secao-lateral-4.component.html',
  styleUrls: ['./secao-lateral-4.component.css',
  './secao-lateral-4-home.component.css',
  './secao-lateral-4.component.scss']
})

export class SecaoLateral4Component implements OnInit {
