...
@Component({
  selector: 'app-secao-lateral-1',
  templateUrl: './secao-lateral-1.component.html',
  styleUrls: ['./secao-lateral-1.component.css',
  './secao-lateral-1-home.component.css',
  './secao-lateral-1.component.scss']
})

export class SecaoLateral1Component implements OnInit {
