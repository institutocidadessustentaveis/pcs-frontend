...
@Component({
  ...
  styleUrls: ['./grupos-academicos.component.css']
})
...
displayedColumns: string[] = ["gruposAcademicos"];
...
scrollUp: any;
  ...
  ngOnInit() {
    ...
    this.buscarEventosTipoAcademiaCalendario();
  ...
  buscarEventosTipoAcademiaCalendario() {
    this.eventoService.buscarEventosTipoAcademiaCalendario().subscribe(res => {
